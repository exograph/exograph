        ...
        let database = DatabaseBuilder::new()
            ...
            .table(
                ...
                vec![
                    pk("id"),
                    string("name"),
                    fk("parent_venue_id", "venues", "id", "venue_fk"),
                ],
            )
            .table(
                "concert_artists",
                vec![
                    pk("id"),
                    fk("concert_id", "concerts", "id", "concert_fk"),
                    fk("artist_id", "artists", "id", "artist_fk"),
                ],
            )
            .table(
                "artists",
                vec![
                    pk("id"),
                    string("name"),
                    fk("address_id", "addresses", "id", "address_fk"),
                ],
            )
            .table("addresses", vec![pk("id"), string("city")])
            .build();
