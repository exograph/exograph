...
use exo_sql_core::{Database, RelationId, TableId};
...
impl SelectionLevel {
    ...
    pub fn with_relation_id(&self, relation_id: RelationId) -> Self {
        match self {
    ...
    pub fn alias(&self, leaf_table: (TableId, Option<String>), database: &Database) -> String {
    ...
    pub fn prefix(&self, database: &Database) -> Option<String> {
        match self {
            SelectionLevel::TopLevel => None,
            SelectionLevel::Nested(relation_ids) => {
    ...
    pub fn self_referencing_table_alias(
        &self,
        table_id: TableId,
        database: &Database,
    ) -> Option<String> {
