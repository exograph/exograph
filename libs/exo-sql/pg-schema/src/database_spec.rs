...
use exo_sql_core::{
    ColumnReference, Database, DatabaseError, ManyToOne, PhysicalColumn, PhysicalIndex,
    PhysicalTable, SchemaObjectName, TableId,
};
...
mod tests {
    ...
    use crate::spec::MigrationScopeMatches;
