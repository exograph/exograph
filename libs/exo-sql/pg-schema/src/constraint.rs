...
#[derive(Debug)]
pub(crate) struct PrimaryKeyConstraint {
    pub(crate) _constraint_name: String,
    pub(crate) columns: Vec<String>,
}

#[derive(Debug)]
pub(crate) struct ForeignKeyConstraintColumnPair {
    pub(crate) self_column: String,
...
pub(crate) struct ForeignKeyConstraint {
    ...
    pub(crate) foreign_table: SchemaObjectName,
    pub(crate) column_pairs: Vec<ForeignKeyConstraintColumnPair>,
}
...
pub(crate) struct Constraints {
    pub(crate) primary_key: Option<PrimaryKeyConstraint>,
    pub(crate) foreign_constraints: Vec<ForeignKeyConstraint>,
...
impl Constraints {
    pub(crate) async fn from_live_db(
...
/// constraints
pub(crate) fn sorted_comma_list<T: ToString>(list: &HashSet<T>, quote_name: bool) -> String {
    let mut list = list
        .iter()
        .map(|item| {
            if quote_name {
