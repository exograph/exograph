...
use super::compute_sql_access_predicate;
use crate::data::operation_mapper::SQLOperationKind;
use crate::data::order_by_mapper::OrderByParameterMapper;
use crate::data::{operation_mapper::SQLMapper, Arguments};
...
impl<'content> DatabaseQuery<'content> {
    ...
    pub async fn operation(
        ...
        let predicate = crate::data::compute_predicate(
    ...
    fn compute_order_by(
        ...
        order_by_param
            ...
            .and_then(|order_by_param| {
                let argument_value = crate::data::find_arg(arguments, &order_by_param.name);
    ...
    fn compute_limit(
        ...
        limit_param
            ...
            .and_then(|limit_param| {
                let argument_value = crate::data::find_arg(arguments, &limit_param.name);
                argument_value
    ...
    fn compute_offset(
        ...
        offset_param
            ...
            .and_then(|offset_param| {
                let argument_value = crate::data::find_arg(arguments, &offset_param.name);
                argument_value
