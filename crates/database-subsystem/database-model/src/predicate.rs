use crate::{column_path::ColumnIdPathLink, model::ModelDatabaseSystem};
...
pub struct PredicateParameter {
    ...
    pub underlying_type_id: SerializableSlabIndex<DatabaseType>,
}
...
impl TypeDefinitionProvider<ModelDatabaseSystem> for PredicateParameterType {
