...
pub const EXO_MCP_QUERY_MODEL_SCOPE: &str = "EXO_MCP_QUERY_MODEL_SCOPE";
pub const EXO_MCP_MUTATION_MODEL_SCOPE: &str = "EXO_MCP_MUTATION_MODEL_SCOPE";
pub const EXO_MCP_QUERY_NAME_SCOPE: &str = "EXO_MCP_QUERY_NAME_SCOPE";
pub const EXO_MCP_MUTATION_NAME_SCOPE: &str = "EXO_MCP_MUTATION_NAME_SCOPE";
