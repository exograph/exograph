...
mod tests {
    use super::*;
    use core_plugin_interface::{error::ModelSerializationError, serializable_system::SerializableSystem};
    ...
    async fn create_postgres_system_from_str(
        ...
        let serialized_system = builder::build_system_from_str(
            model_str,
            file_name,
            vec![Box::new(postgres_model_builder::PostgresSubsystemBuilder {})],
        )
        .await
        .unwrap();
